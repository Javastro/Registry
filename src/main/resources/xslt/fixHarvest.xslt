...
<!-- This XSLT is used to fix up the output of other registries that are often not correct.
...
namespace declarations are missing.
  - This is done fairly crudely by assuming that the "standard" namespace prefixes are used - this is not actually a requirement on registries
  - then any namespace declarations further down the element tree are stripped out.
